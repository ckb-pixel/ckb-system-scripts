...
all: specs/cells/pixel_canvas specs/cells/pixel_lock specs/cells/secp256k1_blake160_sighash_all specs/cells/dao specs/cells/secp256k1_blake160_multisig_all

all-via-docker: ${PROTOCOL_HEADER}
	docker run --rm -v `pwd`:/code ${BUILDER_DOCKER} bash -c "cd /code && make"

specs/cells/pixel_canvas: c/pixel_canvas.c ${PROTOCOL_HEADER} c/common.h
	$(CC) $(CFLAGS) $(LDFLAGS) -o $@ $<
